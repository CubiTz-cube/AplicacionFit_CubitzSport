...
void layer_profile(int* page, Font* fontLekton, Font* fontAldrich, int* actualUser, HashTable* hashTableUsers){
    ...
    GuiTextInputLineInt((Rectangle){ 200, 120+50*2, 300, 30 }, &hashTableUsers->users[*actualUser]->info->old, 50, false);
    ...
    GuiTextInputLineFloat((Rectangle){ 200, 120+50*4, 300, 30 }, &hashTableUsers->users[*actualUser]->info->weight, 50, false);

    GuiDrawText("Altura: ", (Rectangle){ 0, 120+50*5, 300, 30 }, TEXT_ALIGN_LEFT, (Color){ 0, 0, 0, 255 });
    GuiTextInputLineInt2((Rectangle){ 200, 120+50*5, 300, 30 }, &hashTableUsers->users[*actualUser]->info->height, 50, false);
